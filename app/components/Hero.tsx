...
export default function Hero() {
    return (
        <section className='max-w-350 mx-auto px-6 lg:px-8 mt-20 lg:mt-28'>
            <div className='flex flex-col-reverse lg:flex-row items-center lg:items-start justify-between md:gap-15 gap-20'>
                <div className='flex-1 flex flex-col gap-7 items-center text-center lg:items-start lg:text-left'>
                    ...
                    <p className='text-lg md:text-xl text-[#565d6e] font-light'>
                    ...
                    <div className='flex flex-col sm:flex-row w-full sm:w-auto gap-4 mt-2'>
                        <button className='w-full sm:w-auto border border-gray-300 bg-gray-100 hover:bg-white duration-300 rounded-lg px-5 py-3 text-lg font-medium flex items-center justify-center gap-2 text-gray-700 cursor-pointer'>
                            <i className='ri-arrow-down-line'></i>
                            Know more
                        </button>

                        <button className='w-full sm:w-auto bg-[#7b55ce] hover:bg-[#6942b4] duration-300 rounded-lg px-5 py-3 text-lg font-medium text-white cursor-pointer'>Get in touch</button>
                    </div>
                </div>

                <div className='w-[320px] h-80 md:w-100 md:h-100 lg:w-112.5 lg:h-112.5 rounded-full overflow-hidden shrink-0 shadow-lg'>
